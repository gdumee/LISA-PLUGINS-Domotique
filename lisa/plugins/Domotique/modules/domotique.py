...
class Domotique(IPlugin):
    ...
    def __init__(self):
        ...
        self._ = translation = gettext.translation(domain='domotique', localedir=self.path, fallback=True, languages=[self.configuration_lisa['lang']]).ugettext
...
#-----------------------------------------------------------------------------
    def on_offDomo(self, jsonInput):
        ...
        try:
            ...
            return {'plugin': "Domotique", 'method': "on_offDomo", 'body':"Erreur d'encodage du texte" } #   fatal
        except:
            if on =="" or obj =="" :
                return {'plugin': "Domotique", 'method': "on_offDomo", 'body': self._("dont understand") } #   fatal
            #if loc -> non   fatal
        ...
        return {'plugin': "Domotique", 'method': "on_offDomo", 'body': message }
